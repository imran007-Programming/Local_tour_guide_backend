...
const login = async (payload) => {
    ...
    const accessToken = tokenGenarator_1.jwtHelper.genarateToken({ userId: user.id, email: user.email, role: user.role }, config_1.default.ACCESS_TOKEN_SECRET, config_1.default.ACCESS_TOKEN_EXPIRE);
    const refreshToken = tokenGenarator_1.jwtHelper.genarateToken({ userId: user.id, email: user.email, role: user.role }, config_1.default.REFRESH_TOKEN_SECRET, config_1.default.REFRESH_TOKEN_EXPIRE);
    return {
        accessToken,
        refreshToken
    };
