...
router.delete("/remove-profile-pic", (0, authHelper_1.default)(client_1.Role.ADMIN, client_1.Role.GUIDE, client_1.Role.TOURIST), user_controller_1.userController.removeProfilePic);
router.delete("/delete-account", (0, authHelper_1.default)(client_1.Role.ADMIN, client_1.Role.GUIDE, client_1.Role.TOURIST), user_controller_1.userController.deleteAccount);
